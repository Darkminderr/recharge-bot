...
async def process_payment(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    async with async_playwright() as p:
        try:
            ...
            # 4. രണ്ടാമത്തെ ബോക്സിൽ കൃത്യമായി മൊബൈൽ നമ്പർ നൽകുന്നു (Mobile No. ബോക്സ്)
            # പ്ലേസ്ഹോൾഡർ ഉപയോഗിച്ച് താഴത്തെ ബോക്സ് മാത്രം സെലക്ട് ചെയ്യുന്നു
            ...
            # 6. Proceed ബട്ടൺ ക്ലിക്ക് ചെയ്യുന്നു (യെല്ലോ ബട്ടൺ)
            await page.locator('button:has-text("Proceed")').first.click(force=True)
            
            # ടൈമർ വിൻഡോ വരാൻ കുറച്ചു സമയം കാത്തിരിക്കുന്നു
            await asyncio.sleep(4)
            ...
            try:
                ...
                # പെയ്‌മെന്റ് കഴിഞ്ഞാൽ സക്സസ് മെസ്സേജ്!
